...
extern void dm8009p_fbdata(Joint_Motor_t *motor, uint8_t *rx_data,uint32_t data_len);
extern void dm4340p_fbdata(Joint_Motor_t *motor, uint8_t *rx_data,uint32_t data_len);
