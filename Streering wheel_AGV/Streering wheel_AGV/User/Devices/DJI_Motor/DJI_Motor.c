...
/* Global variable --------------------------------------------------------- */
DJI_Motor_Info_Typedef chassis_3508_motor[4]={
		[0] = {
			.Motor_Type = DJI_M3508,
			.ID_Set.RxIdentifier = Chassis_3508_Motor1_RxID,
		},
		
		[1] = {
			.Motor_Type = DJI_M3508,
			.ID_Set.RxIdentifier = Chassis_3508_Motor2_RxID,
		},
		
		[2] = {
			.Motor_Type = DJI_M3508,
			.ID_Set.RxIdentifier = Chassis_3508_Motor3_RxID,
		},
		
		[3] = {
			.Motor_Type = DJI_M3508,
			.ID_Set.RxIdentifier = Chassis_3508_Motor4_RxID,
		}
};
...
{
	if(DJI_Motor->Motor_Type == DJI_GM6020)
   DJI_Motor[0].ID_Set.TxIdentifier = 0x1FF; // 假设6020电机发送ID为0x1FE
  else if(DJI_Motor->Motor_Type == DJI_M3508)
   DJI_Motor[0].ID_Set.TxIdentifier = 0x200; // 假设3508电机发送ID为0x200
