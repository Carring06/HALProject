...
/* 底盘3508电机[n]接收ID */
#define Chassis_3508_Motor1_RxID		0x201			//LQ
#define Chassis_3508_Motor2_RxID		0x202			//LH
#define Chassis_3508_Motor3_RxID		0x203			//RH
#define Chassis_3508_Motor4_RxID		0x204			//RQ
/*	底盘6020电机[n]接收ID */
#define Chassis_6020_Motor1_RxID		0x205			//LQ
#define Chassis_6020_Motor2_RxID		0x206			//LH
#define Chassis_6020_Motor3_RxID		0x207			//RH
#define Chassis_6020_Motor4_RxID		0x208			//RQ
/* 3508减速比 */
...
typedef struct {
	...
	// 编码器解算相关
    int32_t total_ecd;      // 总编码器值（多圈累计，单位：编码步数）
    uint16_t last_ecd;      // 上一次的编码器值
    int16_t round_offset;   // 圈数偏移（有符号整数）
